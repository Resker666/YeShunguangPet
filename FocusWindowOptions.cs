...
public sealed record FocusWindowOptions
{
    ...
    public const double MiniMinimumHeight = 120;
    ...
    public double MiniHeight { get; set; } = 128;
    ...
    public void Normalize()
    {
        ...
        MiniHeight = double.IsFinite(MiniHeight) ? Math.Round(Math.Clamp(MiniHeight, MiniMinimumHeight, 200), 1) : 128;
